 ...
 *
 * Class of static methods to handle edit billboard requests.
 */

public class EditBillboard {
    /**
     * This is the method to handle the edit billboard request.
     *
     * @param parameters a string ArrayList of the parameters to edit the existing billboard.
     ...
     */
    public static void editBillboard(ArrayList<String> parameters, HashMap<String, ArrayList<String>> sessions, ObjectOutputStream oos) throws IOException {
