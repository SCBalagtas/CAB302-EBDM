...
public class CreateUser {
    public void main(JFrame frame) throws ClassNotFoundException, UnsupportedLookAndFeelException, InstantiationException, IllegalAccessException, IOException {
        ...
        JButton addUser = new JButton(new AbstractAction("AddUser") {           //Requests server add selected permissions to selected user
            @Override
            public void actionPerformed(ActionEvent e) {
                ...
                } catch (IOException | ClassNotFoundException | NoSuchAlgorithmException | IllegalAccessException | InstantiationException | UnsupportedLookAndFeelException ex) {
                    ex.printStackTrace();
                }
            }
        });
